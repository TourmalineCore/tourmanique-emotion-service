...
from routes.emotions_routes import emotions_blueprint
...
def register_blueprints(app):
    ...
    emotions_service_blueprint = Blueprint('emotions-service', __name__, url_prefix='/emotions-service')
    emotions_service_blueprint.register_blueprint(emotions_blueprint)

    app.register_blueprint(emotions_service_blueprint)
